...
--> statement-breakpoint
ALTER TABLE "transcriptions" ADD COLUMN "segments" jsonb DEFAULT '[]'::jsonb NOT NULL;--> statement-breakpoint
ALTER TABLE "transcriptions" ADD COLUMN "user_name" text;--> statement-breakpoint
DO $$ BEGIN
