...
def translate_with_ollama(text):
    ...
    print("In side translate: "+text)
    response = ollama.generate(model= "llama3.1", prompt = "Translate the following text to Engolish:"+text+"\n SUMMARY:\n")
...
def summarize(text):
    ...
    print("In side summrisation: "+text)
